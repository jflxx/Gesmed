...
<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="GestionFarmacias.aspx.cs" Inherits="GesmedWA.Views.GestionFarmacias" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="container mt-2">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                ...
                <asp:TextBox ID="txtNombreContacto" runat="server" CssClass="form-control" MaxLength="40"></asp:TextBox>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <label for="nombreFarmacia" class="form-label">Nombre Farmacia</label>
                <asp:TextBox ID="txtNombreFarmacia" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
            </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <label for="numeroDeLicencia" class="form-label">Número de Licencia</label>
                <asp:TextBox ID="txtNumeroDeLicencia" runat="server" CssClass="form-control"></asp:TextBox>
            </div>

            <div class="col-12 col-sm-6 col-lg-4">
                <label for="tipoFarmacia" class="form-label">Tipo de Farmacia</label>
                <asp:DropDownList ID="ddlTipoFarmacia" runat="server" CssClass="form-select">
                    <asp:ListItem Text="Seleccione un tipo" Value="" Enabled="False" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="ESTANDAR">ESTANDAR</asp:ListItem>
                    <asp:ListItem Value="MEDIANA">MEDIANA</asp:ListItem>
                    <asp:ListItem Value="CADENA">CADENA</asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbSeleccionarAdministrador" CssClass="btn btn-success" runat="server"
                                                    Text="<i class='fa-solid fa-check'></i> Seleccionar" CommandArgument='<%# Eval("IdAdministrador") %>'
                                                    OnClick="lbSeleccionarAdministrador_Click" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
    ...
    <div id="error-modal" class="modal" tabindex="-1" aria-labelledby="error-modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="error-modalLabel">Error de datos</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <contenttemplate>
